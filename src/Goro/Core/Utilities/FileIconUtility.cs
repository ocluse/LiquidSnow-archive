...
{
    /// <summary>
    /// Contains utility methods for obtaining file thumbnails depending on the current environment.
    /// </summary>
    public static class FileIconUtility
    {
        private static readonly Dictionary<string, ImageSource> _smallIconCache = new();
        private static readonly Dictionary<string, ImageSource> _largeIconCache = new();
        ...
        /// </summary>     
        private static ImageSource ToImageSource(this SIcon icon)
        {
