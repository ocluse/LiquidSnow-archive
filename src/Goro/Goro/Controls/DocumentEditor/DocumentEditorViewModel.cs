...
namespace Thismaker.Goro
{
    internal class DocumentEditorViewModel:BindableBase
    {
        ...
        {
            _fonts = new ObservableCollection<FontFamily>(System.Windows.Media.Fonts.SystemFontFamilies);
        ...
        private FontFamily? CheckFont()
        {
            ...
            object? font = _document.Selection.GetPropertyValue(Control.FontFamilyProperty);
        ...
        private bool? CheckBold()
        {
            ...
            var bold = _document.Selection.GetPropertyValue(TextElement.FontWeightProperty);
        ...
        {
            _document?.Selection.ApplyPropertyValue(TextElement.FontWeightProperty,
                    value.HasValue ? (value.Value ? FontWeights.Bold : FontWeights.Normal) : FontWeights.Normal);
        }
        ...
        private void SetItalic(bool? value)
        {
            _document?.Selection.ApplyPropertyValue(Control.FontStyleProperty,
                   value.HasValue ? (value.Value ? FontStyles.Italic : FontStyles.Normal) : FontStyles.Normal);
        }
