...
namespace Thismaker.Goro
{
    ...
    public static partial class IconManager
    {
        ...
        /// <param name="scheme">The scheme to load. Cannot load <see cref="IconDesign.Segoe"/> as that is a font</param>
        ...
        /// </summary>
        /// <param name="icon">The icon to load</param>
        /// <param name="scheme">The scheme to use. Cannot load <see cref="IconDesign.Segoe"/> as that is a font</param>
        ...
        /// </summary>
        /// <param name="icon">The icon to load</param>
        /// <param name="scheme">The scheme to use. Cannot load <see cref="IconDesign.Segoe"/> as that is a fon</param>
